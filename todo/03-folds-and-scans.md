...
- [X] DONE — `|` and `&` have carrier-directed q-style same-carrier behavior over all three implemented carriers; mixed carriers refuse pending the coercion table.
