 ...
 * NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE
NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE 
NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE 
NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE 
NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE  NOT IN SCOPE 
...
int fs_write_commit(const char *path, const char *data, size_t len) {
  ...
  if (n < 0 || n >= (int)sizeof staged) { errno = ENAMETOOLONG; return -1; }
  FILE *f = fopen(staged, "wb");
  if (!f) return -1;
  if (fwrite(data, 1, len, f) != len || fflush(f)) {
    int e = ferror(f) ? errno : EIO; fclose(f); unlink(staged); errno = e; return -1;
  }
  if (fsync(fileno(f))) { int e = errno; fclose(f); unlink(staged); errno = e; return -1; }
  if (fclose(f)) { int e = errno; unlink(staged); errno = e; return -1; }
  if (rename(staged, path)) { int e = errno; unlink(staged); errno = e; return -1; }
  return 0;
}
