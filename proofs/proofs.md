...
- `tick-induction.md` — the Kore tick map over the demo corpus: fixed-point, verified-orbit, additive-absorption, and geometric-saturation theorems with executable witnesses, and the exact finite horizons where no induction exists.
